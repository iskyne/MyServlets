...
public class SystemLogHandler extends PrintStream {
     ...
     */
    private static final ThreadLocal<Stack<CaptureLog>> logs = new ThreadLocal<Stack<CaptureLog>>();


    /**
     * Spare CaptureLog ready for reuse.
     */
    private static final Stack<CaptureLog> reuse = new Stack<CaptureLog>();
